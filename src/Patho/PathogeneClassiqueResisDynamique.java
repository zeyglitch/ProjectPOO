public class PathogeneClassiqueResisDynamique extends Pathogene implements IResistanceDynamique {
    public PathogeneClassiqueResisDynamique(String nom, float currentChargeInf, float tauxRep, float sensibilite, float resistanceMedm, Patient patient, Traitement traitement) {
    ...
    protected float updateChargeInf() {
        ...
        float Lt = Math.max(0, currentChargeInf + currentChargeInf * tauxRep - sensibilite * patient.getReactiviteSI() - totAlpham * totDmt *(1-resistanceMedm) );
